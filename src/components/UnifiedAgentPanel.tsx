...
export function UnifiedAgentPanel({ assets, agents, portfolio, autoTradeEnabled, onToggleAutoTrade, onExecuteSignal }: UnifiedAgentPanelProps) {
  ...
  const handleToggleAutoTrade = (checked: boolean) => {
    ...
    toast.success(checked ? 'Auto-trading enabled - agents will scan every 30 seconds' : 'Auto-trading disabled')
  }
          ...
          {autoTradeEnabled && (
            <div className="bg-accent/10 border border-accent/30 rounded-lg p-4 space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Unified agents automatically scan top assets every 30 seconds. Trades are executed when all agents reach 60%+ confidence consensus.
              </p>
              <div className="grid grid-cols-3 gap-3 mt-3 text-xs">
                <div className="bg-background rounded p-2">
                  <div className="text-muted-foreground">Safety Threshold</div>
                  <div className="font-medium">60% Confidence</div>
                </div>
                <div className="bg-background rounded p-2">
